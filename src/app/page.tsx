    ...
    return (
      ...
      `}</style>
            ...
            <header style={{
                ...
                <h1 style={{fontSize: '24px', fontWeight: 700, margin: 0}} className="header-title">Loft Section
                    Generator</h1>
                <div style={{width: '1px', height: '20px', background: 'var(--border2)'}} className="header-divider"/>
                <span style={{fontSize: '22px', color: 'var(--subtle)', fontWeight: 300}}
                      className="header-subtitle">截面曲線產生工具</span>
            </header>
                    ...
                    <div style={{paddingBottom: '14px', marginBottom: '14px', borderBottom: '1px solid var(--border)'}}>
                        ...
                        <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '7px'}}>
                            <div>
                                <label style={{
                                    ...
                                    marginBottom: '4px',
                                    display: 'block'
                                }}><strong>寬 Width</strong></label>
                                <div style={{display: 'flex', gap: '6px', alignItems: 'center'}}>
                                    <input type="number" value={inpW} onChange={(e) => setInpW(e.target.value)} min="1"
                                           step="0.1"/>
                            ...
                            <div>
                                <label style={{
                                    ...
                                    marginBottom: '4px',
                                    display: 'block'
                                }}><strong>高 Height</strong></label>
                                <div style={{display: 'flex', gap: '6px', alignItems: 'center'}}>
                                    <input type="number" value={inpH} onChange={(e) => setInpH(e.target.value)} min="1"
                                           step="0.1"/>
                                    <span style={{fontSize: '13px', color: 'var(--subtle)'}}>mm</span>
                                </div>
                            </div>
                        ...
                        <div style={{marginTop: '10px'}}>
                            <label style={{
                                ...
                                marginBottom: '4px',
                                display: 'block'
                            }}><strong>圓角半徑 Radius</strong></label>
                            <div style={{display: 'flex', gap: '6px', alignItems: 'center'}}>
                                <input type="number" value={inpR} onChange={(e) => setInpR(e.target.value)} min="0"
                                       step="0.1"/>
                                <span style={{fontSize: '13px', color: 'var(--subtle)'}}>mm</span>
                            </div>
                        </div>
                    ...
                    <div style={{paddingBottom: '14px', marginBottom: '14px', borderBottom: '1px solid var(--border)'}}>
                        ...
                        <div>
                            <label style={{
                                ...
                                marginBottom: '4px',
                                display: 'block'
                            }}><strong>直徑 Diameter</strong></label>
                            <div style={{display: 'flex', gap: '6px', alignItems: 'center'}}>
                                <input type="number" value={inpD} onChange={(e) => setInpD(e.target.value)} min="2"
                                       step="0.1"/>
                                <span style={{fontSize: '13px', color: 'var(--subtle)'}}>mm</span>
                            </div>
                        </div>
                    ...
                    <div style={{paddingBottom: '14px', marginBottom: '14px', borderBottom: '1px solid var(--border)'}}>
                        ...
                        <div style={{marginBottom: '8px'}}>
                            <label style={{
                                ...
                                marginBottom: '4px',
                                display: 'block'
                            }}><strong>過渡曲線數量</strong> <span
                                style={{fontSize: '12px', color: 'var(--subtle)'}}>（不含兩端）</span></label>
                            <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                                <input type="range" min="1" max="10" step="1" value={slNum}
                                       onChange={(e) => setSlNum(e.target.value)} style={{flex: 1}}/>
                                <span style={{
                                    fontFamily: 'var(--mono)',
                                    fontSize: '15px',
                                    color: 'var(--accent)',
                        ...
                        <div style={{marginBottom: '8px'}}>
                            <label style={{
                                ...
                                marginBottom: '4px',
                                display: 'block'
                            }}><strong>IBL 點密度</strong></label>
                            <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                                <input type="range" min="256" max="2048" step="256" value={slPts}
                                       onChange={(e) => setSlPts(e.target.value)} style={{flex: 1}}/>
                                <span style={{
                                    fontFamily: 'var(--mono)',
                                    fontSize: '15px',
                                    color: 'var(--accent)',
                            ...
                            <div style={{
                                ...
                                color: 'var(--subtle)',
                                lineHeight: 1.6
                            }}>數值越高，IBL 曲線越平滑，匯出檔案也越大。預設 1024。
                            </div>
                        </div>
                                ...
                                {['linear', 'cosine', 'smoothstep', 'smootherstep'].map((mode) => (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            cursor: 'pointer',
                                            textAlign: 'center',
                                            fontWeight: interpMode === mode ? 600 : 500,
                                        }}
                                    >
            ...
            {/* Canvas */}
            <div ref={cvWrapRef}
                 style={{gridRow: 2, background: 'var(--bg)', display: 'flex', padding: '14px', position: 'relative'}}
                ...
                <div style={{
                    ...
                    <button onClick={() => {
                        const z = applyZoomClamp(zoom * 1.25);
                        setZoom(z);
                        const [px, py] = clampPan(panX, panY, z);
                        setPanX(px);
                        setPanY(py);
                    }} title="放大" style={{
                        width: '28px',
                    ...
                    <button onClick={() => {
                        const z = applyZoomClamp(zoom * 0.8);
                        setZoom(z);
                        const [px, py] = clampPan(panX, panY, z);
                        setPanX(px);
                        setPanY(py);
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <div style={{fontSize: '11px', fontFamily: 'var(--mono)', color: 'var(--subtle)'}}>參數 t ∈ [0,
                            1]，對應角度 0° → 360°
                        </div>
                    </div>
                    <div style={{
                ...
                <div style={{
                    ...
                    {equations.map((eq, idx) => (
                        <div key={idx} style={{
                            background: 'var(--surface2)',
                            border: `1px solid ${highlightEqIdx === idx ? 'var(--accent)' : 'var(--border)'}`,
                            borderRadius: 'var(--radius)',
                            padding: '10px 12px',
                            flexShrink: 0,
                            transition: 'border-color 0.2s ease',
                            boxShadow: highlightEqIdx === idx ? '0 0 0 2px rgba(37,99,235,0.2)' : 'none'
                        }} className="eq-card">
                            <div style={{
                                fontSize: '11px',
                                fontWeight: 700,
                                ...
                                <div style={{display: 'flex', gap: '4px'}}>
                                    <button
                                        onClick={(e) => doExport(`Open Arclength\nBegin section ! 1\nBegin curve ! 1\n${eq.iblData}\n`, eq.fileName, e.currentTarget)}
                                        style={{
                                            borderColor: '#A7F3D0',
                                            color: 'var(--accent2)',
                                            ...
                                            cursor: 'pointer',
                                            whiteSpace: 'nowrap'
                                        }} className="btn-sm ibl">↓ .ibl
                                    </button>
                                    <button onClick={(e) => doCopy(eq.equation, e.currentTarget)} style={{
                                        background: 'var(--surface2)',
                                        border: '1px solid var(--border)',
                                        borderRadius: '6px',
                                        color: 'var(--muted)',
                            ...
                            <div style={{
                                ...
                                wordBreak: 'break-all'
                                 ...
                                 dangerouslySetInnerHTML={{__html: eq.equation.replace(/^[xyz](?= =)/gm, '<span class="var">$&</span>').replace(/\b(\d+\.?\d*)\b/g, '<span class="val">$1</span>').replace(/\b(pow|abs|cos|sin)\b/g, '<span class="fn">$1</span>')}}/>
                            <div style={{
                                marginTop: '6px',
                                padding: '5px 8px',
                                background: 'var(--surface)',
                                ...
                                起點 (<span
                                style={{color: 'var(--accent2)'}}>{fmtChk(eq.checkData.startPt[0])}</span>, <span
                                style={{color: 'var(--accent2)'}}>{fmtChk(eq.checkData.startPt[1])}</span>)
                                ¼周 (<span
                                style={{color: 'var(--accent2)'}}>{fmtChk(eq.checkData.quarterPt[0])}</span>, <span
                                style={{color: 'var(--accent2)'}}>{fmtChk(eq.checkData.quarterPt[1])}</span>)
